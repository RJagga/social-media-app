...
import "./addtopost.css";
import { AuthContext } from "../../../contexts/AuthContext";
import { handleAddPost } from "../../../apis/fetchapi";
...
const AddPostImg = ({ Closebtn }) => {
  ...
  const CLOUDINARY_UPLOAD_PRESET = "rishab";
  ...
  const handleSubmit = async (e) => {
    ...
    await fetch(import.meta.env.VITE_REACT_APP_CLOUDINARY_URL, {
      method: "POST",
      body: formData,
    })
